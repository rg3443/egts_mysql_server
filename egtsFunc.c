...
void PrintPosData(s_sr_pos_data * sr_pos_data, uint32_t tim)
{
        ...
        case EGTS_PT_APPDATA://1
            if (hdr->FDL) {
                ...
                switch (rst) {// switch by Service Type  RST
                        ...
                        while (uke > uki) {
                            ...
                            switch (rtype) {// SRT (Subrecord Type)
                                ...
                                case EGTS_SR_POS_DATA:// 16
                                    ...
                                    if(mysqlConnected) {
                                        SQLQuerryPosData(conn_,NULL,sr_pos_data);
                                    }
                                    printf("pos_data5\n");
                                break;
                                ...
                                case EGTS_SR_ABS_DIG_SENS_DATA://23
									...
									s_sr_abs_dig_sens_data * adsd = sr_abs_dig_sens_data;
									uint16_t digitalSensNum = (adsd->DSN_high << 8) | adsd->DSN_low;
									printf("EGTS_SR_ABS_DIG_SENS_DATA:\n\tASN:%d\n\tASV:%d\n",digitalSensNum,adsd->DSST);
                    ...
                    break;
                    case EGTS_COMMANDS_SERVICE ://    (4)
                        printf("EGTS_COMMANDS_SERVICE");
                    break;
                    case EGTS_FIRMWARE_SERVICE ://    (9)
                        printf("EGTS_FIRMWARE_SERVICE");
                    break;
                    case EGTS_ECALL_SERVICE ://        (10)
                        printf("EGTS_ECALL_SERVICE");
                    break;
                        default : printf("EGTS_UNKNOWN");
